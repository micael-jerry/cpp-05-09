...
This module is designed to help you understand 'container templates' iterators and 'algorithms' in CPP.

## Ressources

- [Containers in C++ STL](https://www.geeksforgeeks.org/cpp/containers-cpp-stl/)
- [Comprendre conteneurs C++](https://blog.alphorm.com/comprendre-conteneurs-cplusplus-code-efficace)
