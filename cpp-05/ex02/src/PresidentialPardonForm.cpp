...
PresidentialPardonForm::PresidentialPardonForm() : AForm("shrubbery_creation_form", PRESIDENTIALPARDONFORM_SIGN_GRADE_REQUIRED, PRESIDENTIALPARDONFORM_EXEC_GRADE_REQUIRED), _target("default_target") {}

PresidentialPardonForm::PresidentialPardonForm(std::string const &target) : AForm("shrubbery_creation_form", PRESIDENTIALPARDONFORM_SIGN_GRADE_REQUIRED, PRESIDENTIALPARDONFORM_EXEC_GRADE_REQUIRED), _target(target) {}
